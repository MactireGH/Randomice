...
def get_create_main_tab(surface):
    ...
    ttk.Label(grid_input, text=label_ru['animals_group']).grid(row=1, column=0, sticky='w', pady=5)
    ...
    ttk.Label(grid_input, text=label_ru['deviation']).grid(row=2, column=0, sticky='w', pady=5)
    ...
    button_result = ttk.Button(frame_button, text=label_ru['calculate'])
